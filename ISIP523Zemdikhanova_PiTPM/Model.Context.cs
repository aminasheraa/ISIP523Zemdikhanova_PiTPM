...
namespace ISIP523Zemdikhanova_PiTPM
{
    ...
    public partial class PR14GordovEntities : DbContext
    {
        public PR14GordovEntities()
            : base("name=PR14GordovEntities")
        {
        }
        ...
        public virtual DbSet<SeatSession> SeatSession { get; set; }
